...
O repositório contém o arquivo com extensão .ino referente à implementação e experimentação do protocolo MQTT (Message Queuing Telemetry Transport) aplicado a um cenário de Internet das Coisas (IoT). O MQTT consiste em um protocolo de comunicação orientado à troca de mensagens em um modelo de publicação e assinatura (publish/subscribe), caracterizado por sua leveza e eficiência, sendo amplamente utilizado em sistemas com recursos computacionais limitados e conectividade instável ou de baixa largura de banda.

O funcionamento do MQTT baseia-se na interação entre três componentes principais:
...
O diagrama de circuito é exibido na imagem a baixo

![Diagrama do circuito](imagens/esquema_eletronico.png)
...
|-------|--------|----------|
| Publicação (LDR) | `sala/esp/ldr` | Envia valor do sensor de luminosidade |
