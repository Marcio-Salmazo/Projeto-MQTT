...
const char* topic_proximity_sensor = "home/esp8266/proximity"
...
/*
  ...
  D5 -> Pino digital para acionamento do Gatilho do sensor
  D6 -> Pino digital para retorno da distância calculada
*/
const int pinLED = D1;    
const int pinLDR = A0; 
...
/*
   ...
   com base em pulsos ultrassoniccos do sensor.
*/
long readUltrasonic() {
...
void setup() {
  ...
  // Definição do comportamento dos pinos referentes ao sensor HC SR-04
  ...
  */
  ...
  if (now - lastPublish >= PUBLISH_INTERVAL_MS) {
    ...
    */
    ...
    //..........................................................................................
    // PUBLICAÇÃO DO SENSOR DE PROXIMIDADE

    long distancia = readUltrasonic();
    /*
      Cria um buffer (payload) para armazenar o JSON que será enviado por MQTT.
      'snprintf' escreve dentro do buffer um JSON no formato: {\"distancia\":%ld}", distancia),
    */
    char payload_dist[50];
    snprintf(payload_dist, sizeof(payload_dist), "{\"distancia\":%ld}", distancia);
    client.publish(topic_proximity_sensor, payload_dist, true);

    //Mensagens de LOG no monitor serial informando o payload enviado
    Serial.print("Publicado Sensor de proximidade: ");
